  		...
  		*/
            ...
            for (StructGroupStat groupStat : groupStats) {
                ...
                for (StructStorageStat storageStat : storageStats) {
                    ...
                    System.out.println("\t\tup time = " + (storageStat.getUpTime().getTime() == 0? "" :
                            df.format(storageStat.getUpTime())));
                    ...
                    System.out.println(
                            "\t\tlast_synced_timestamp = " + df.format(storageStat.getLastSyncedTimestamp()) +
